...
describe('probando metodos y condicionales', () => {
    ...
    it('probando metodo', () => {
        expect(componente.condicionales()).toBe('variable 1 verdadero');
    });

    it('probando variable 1 falsa', () => {
        componente.variable1 = false;
        expect(componente.condicionales()).toBe('variable 2 y 3 verdaderas');
    });

    it('probando variable 1 y 3 falsas', () => {
        componente.variable1 = false;
        componente.variable3 = false;
        expect(componente.condicionales()).toBe('variable 2 es verdadera');
    });
    ...
    it('probando todas son falsas', () => {
        ...
        componente.variable3 = false;
        expect(componente.condicionales()).toBe('todas son falsas');
    });
});
